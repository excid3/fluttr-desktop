...
class PreferencesFluttrdesktopDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesFluttrdesktopDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesFluttrdesktopDialog object.
        """
        builder = get_builder('PreferencesFluttrdesktopDialog')
        new_object = builder.get_object("preferences_fluttrdesktop_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesFluttrdesktopDialog object with it in order to
        finish initializing the start of the new PerferencesFluttrdesktopDialog
        instance.
...
if __name__ == "__main__":
    dialog = PreferencesFluttrdesktopDialog()
    dialog.show()
    gtk.main()
